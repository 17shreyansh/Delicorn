    ...
    <div style={{ 
      ...
      <Row style={{ minHeight: '100vh' }}>
        ...
        <Col xs={0} md={12} lg={14} xl={16}
          style={{
            backgroundImage: `linear-gradient(rgba(13, 75, 75, 0.7), rgba(13, 75, 75, 0.7)), url(${heroImage})`,
          ...
          <div style={{ width: '100%', maxWidth: '400px' }}>
            ...
            >
              ...
              <Form onFinish={onFinish} layout="vertical" size="large">
                ...
                >
                  <Input 
                    prefix={<UserOutlined style={{ color: '#0d4b4b' }} />} 
                ...
                >
                  <Input 
                    prefix={<MailOutlined style={{ color: '#0d4b4b' }} />} 
                ...
                >
                  <Input 
                    prefix={<PhoneOutlined style={{ color: '#0d4b4b' }} />} 
                ...
                >
                  <Input.Password 
                    prefix={<LockOutlined style={{ color: '#0d4b4b' }} />} 
                ...
                >
                  <Checkbox style={{ fontFamily: "'Josefin Sans', sans-serif" }}>
                    I agree to the <Link to="/terms" className="auth-link" style={{ color: '#0d4b4b', transition: 'all 0.3s ease' }}>Terms & Conditions</Link> and <Link to="/privacy" className="auth-link" style={{ color: '#0d4b4b', transition: 'all 0.3s ease' }}>Privacy Policy</Link>
                  </Checkbox>
                </Form.Item>
