...
const AshtaDhatuProducts = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const response = await apiService.getProductsByType('ashta-dhatu');
  ...
  const handleAdd = () => {
    navigate('/admin/products/add?type=ashta-dhatu');
  };
...
export default AshtaDhatuProducts;